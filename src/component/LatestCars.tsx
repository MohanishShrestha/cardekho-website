...
export default function LatestCars() {
  return (
    <div className="w-full bg-white max-w-7xl mx-auto px-4 py-8 border shadow-xl rounded-2xl mt-10">
      <h2 className="text-center text-2xl font-bold mb-10 text-green-500">Latest Cars</h2>
          ...
          >
            <CardContent className="p-0 m-3 ">
              ...
              <div className="p-6">
                ...
                <Button className="bg-green-500 hover:bg-green-600 text-white w-full rounded-2xl mt-5 py-6 text-md">
                  BUY NOW
                </Button>
              </div>
            </CardContent>
